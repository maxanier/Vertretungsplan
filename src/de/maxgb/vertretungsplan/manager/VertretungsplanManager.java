...
public class VertretungsplanManager {
	public interface OnUpdateFinishedListener {
		public void onVertretungsplanUpdateFinished(boolean update);// Wenn update==false Keine �nderung
	}
	...
	private boolean auswertenLehrer(File f) {
		...
		for (int j = 0; j < font.getLength(); j += 3) { // Durchlaufen
			...
			// Zwei M�glichkeiten: 1. Mit Nachrichten zum Tag 2. ohne Nachrichten zum Tag
			Node table = null;
