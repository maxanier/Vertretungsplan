...
/**
 * @author Max
 *Updater Klasse, die zum Beispiel Einstellung oder Tabauswahl bei einem App-Update, fall nötig, updated.
 *Stellt außerdem ein Changelog zur Verfügung
 */
public class Updater {
	private static final String TAG="Updater";
	/**
	 * Führt fall ein App-Update geschehen ist, die benötigten updates durch und liefert ein Changelog zurück.
	 * @param pref SharedPreferences zum Bearbeiten und zum Speichern des letzten Updates
