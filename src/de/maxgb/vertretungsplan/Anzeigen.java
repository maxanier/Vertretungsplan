...
public class Anzeigen extends SherlockFragmentActivity implements ActionBar.TabListener {
  ...
  */
  ...
  /**
  * Abstrakte Fragmente LehereAnzeigeFragment und SchuelerAnzeigeFragment mit einigen fertigen Methoden
  * 
  */
  public static abstract class AnzeigeFragment extends Fragment
  {
    String stand ="";
    protected abstract void hinzufuegen(ArrayList<Vertretung> vertretungen, NodeList childnodes);
    protected abstract void neuer Tag TODO
  ...
  public static abstract class LehrerAnzeigeFragment extends AnzeigeFragment{
    
    protected void hinzufuegen(ArrayList<Vertretungen> vertretungen, NodeList childnodes){
      //Liest Vertreter aus. Besonderheit: Kann tiefer gespeichert sein, falls durchgestrichen
      Node nvertreter = childnodes.item(0).getChildNodes().item(0).getChildNodes().item(0);
      String vertreter= "";
      ...
      String art = childnodes.item(1).getChildNodes().item(0).getNodeValue();
      String stunde = childnodes.item(2).getChildNodes().item(0).getNodeValue();
      String klasse= childnodes.item(3).getChildNodes().item(0).getNodeValue();
      String vgplan = childnodes.item(4).getChildNodes().item(0).getNodeValue();
      Node nfach = childnodes.item(5)
      .getChildNodes().item(0);
      String fach = "";
      if (nfach.getNodeType() == Node.TEXT_NODE) {
        fach = nfach.getNodeValue();
      } else if (nfach.getNodeType() == Node.ELEMENT_NODE) {
        fach = nfach.getChildNodes()
        .item(0).getNodeValue();
      }
      String raum = childnodes.item(6).getChildNodes().item(0).getNodeValue();
      String vstatt = childnodes.item(7).getChildNodes().item(0).getNodeValue();
      String bemerkungen = childnodes.item(8).getChildNodes().item(0).getNodeValue();
      String klausur = childnodes.item(9).getChildNodes().item(0).getNodeValue();
      vertretungen.add(new LehrerVertretungen(vertreter,art,stunde,klasse,vgplan,fach,raum,vstatt,bemerkungen,klausur));
    } 
  }  
  
  private static abstract class SchuelerAnzeigeFragment extends AnzeigeFragment {
    ...
    protected void anzeigen(ArrayList<SchuelerVertretung> vertretungen, ScrollView s) {
  ...
  */
  ...
  @SuppressLint("NewApi")
  public static class EigeneKurseFragment extends SchuelerAnzeigeFragment {
    ...
    Bundle savedInstanceState) {
      ...
      try {
        if (f.exists()) { // Wenn Datei vorhanden->Auswerten
          ArrayList<SchuelerVertretung> vertretungen = auswerten(f);
  ...
  */
  ...
  public static class EigeneStufeFragment extends SchuelerAnzeigeFragment {
  ...
  */
  ...
  public static class AlleVertretungenFragment extends SchuelerAnzeigeFragment {
